...
class FavoritesViewModelTest {
    ...
    @Test
    fun `viewModel loads favorite places on initialization`() = runTest {
        // Given
    ...
    @Test
    fun `addFavoritePlace calls use case with correct parameters`() = runTest {
        // Given
    ...
    @Test
    fun `deleteFavoritePlace calls use case with correct id`() = runTest {
        // Given
        coEvery { favouritesPlacesUseCase.getAllFavoritePlaces() } returns flowOf(emptyList())
    ...
    @Test
    fun `favoritePlaces starts empty when no data available`() = runTest {
        // Given
        coEvery { favouritesPlacesUseCase.getAllFavoritePlaces() } returns flowOf(emptyList())
    ...
    @Test
    fun `favoritePlaces updates when use case emits new data`() = runTest {
        // Given
    ...
    @Test
    fun `addFavoritePlace handles places with special characters`() = runTest {
        // Given
        coEvery { favouritesPlacesUseCase.getAllFavoritePlaces() } returns flowOf(emptyList())
        coEvery { favouritesPlacesUseCase.addFavoritePlace(any()) } returns Unit
    ...
    @Test
    fun `multiple deleteFavoritePlace calls are handled correctly`() = runTest {
        // Given
        coEvery { favouritesPlacesUseCase.getAllFavoritePlaces() } returns flowOf(emptyList())
        coEvery { favouritesPlacesUseCase.deleteFavoritePlace(any()) } returns Unit
