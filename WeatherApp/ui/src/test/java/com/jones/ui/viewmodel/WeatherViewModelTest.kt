...
class WeatherViewModelTest {
    ...
    @Test
    fun `updateLocation fetches weather for given coordinates`() =
        runTest {
            // Given
    ...
    @Test
    fun `fetchWeather uses default coordinates when no location set`() =
        runTest {
            // Given
    ...
    @Test
    fun `updateLocation updates current coordinates`() =
        runTest {
            // Given
