...
class GetForecastUseCaseTest {
    ...
    @Test
    fun `invoke triggers fetch and returns forecast from db`() =
        runTest {
            // Given
            val latitude = -1.2921
    ...
    @Test
    fun `invoke returns empty list when no forecast data in db`() =
        runTest {
            // Given
            val latitude = -1.2921
            val longitude = 36.8219
    ...
    @Test
    fun `invoke handles different count values`() =
        runTest {
            // Given
            val latitude = -1.2921
            val longitude = 36.8219
    ...
    @Test
    fun `invoke returns forecast with different weather types`() =
        runTest {
            // Given
            val latitude = -1.2921
            val longitude = 36.8219
    ...
    @Test
    fun `invoke maintains forecast order from repository`() =
        runTest {
            // Given
            val latitude = -1.2921
            val longitude = 36.8219
