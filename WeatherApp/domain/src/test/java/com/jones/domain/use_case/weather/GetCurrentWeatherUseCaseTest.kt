...
class GetCurrentWeatherUseCaseTest {
    ...
    @Test
    fun `invoke triggers fetch and returns current weather from db`() =
        runTest {
            // Given
            val latitude = -1.2921
    ...
    @Test
    fun `invoke returns null when no weather data in db`() =
        runTest {
            // Given
            val latitude = -1.2921
            val longitude = 36.8219
    ...
    @Test
    fun `invoke handles different weather conditions`() =
        runTest {
            // Given
            val latitude = -1.2921
            val longitude = 36.8219
    ...
    @Test
    fun `invoke works with different coordinates`() =
        runTest {
            // Given
