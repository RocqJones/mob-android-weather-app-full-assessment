...
class FavouritesPlacesUseCaseTest {
    ...
    @Test
    fun `getAllFavoritePlaces returns list of favorite places`() =
        runTest {
            // Given
            val favoritePlaces =
                listOf(
    ...
    @Test
    fun `getAllFavoritePlaces returns empty list when no favorites`() =
        runTest {
            // Given
    ...
    @Test
    fun `addFavoritePlace successfully adds new place`() =
        runTest {
            // Given
            val newPlace =
                FavoritePlace(
    ...
    @Test
    fun `addFavoritePlace handles place with auto-generated id`() =
        runTest {
            // Given
            val newPlace =
                FavoritePlace(
    ...
    @Test
    fun `deleteFavoritePlace removes place by id`() =
        runTest {
            // Given
            val placeId = 5
    ...
    @Test
    fun `getFavoritePlaceById returns correct place`() =
        runTest {
            // Given
            val placeId = 3
            val expectedPlace =
    ...
    @Test
    fun `getFavoritePlaceById returns null when place not found`() =
        runTest {
            // Given
            val placeId = 999
    ...
    @Test
    fun `getAllFavoritePlaces handles places with different coordinates`() =
        runTest {
            // Given
            val favoritePlaces =
                listOf(
    ...
    @Test
    fun `addFavoritePlace preserves timestamp`() =
        runTest {
            // Given
    ...
    @Test
    fun `getAllFavoritePlaces maintains order from repository`() =
        runTest {
            // Given
            val favoritePlaces =
                listOf(
    ...
    @Test
    fun `deleteFavoritePlace handles multiple deletes`() =
        runTest {
            // Given
    ...
    @Test
    fun `addFavoritePlace handles places with same coordinates but different names`() =
        runTest {
            // Given
            val place1 =
                FavoritePlace(
